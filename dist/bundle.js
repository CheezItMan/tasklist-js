...
var Task = _backbone2.default.Model.extend({
  defaults: {
    title: '',
    completed: false
  },
...
var TaskList = _backbone2.default.Collection.extend({
...
var _task_view = __webpack_require__(4);

var _task_view2 = _interopRequireDefault(_task_view);
...
var TaskListView = _backbone2.default.View.extend({
  initialize: function initialize(params) {
    this.template = params.template;
  },
  render: function render() {
    ...
    this.model.each(function (task) {
      ...
      var taskView = new _task_view2.default({
        model: task,
  ...
  readNewTaskForm: function readNewTaskForm() {
  ...
  addTask: function addTask(e) {
    ...
    var task = new _task2.default(taskData);
    this.model.add(task);
  }
});
...
var _settings2 = __webpack_require__(7);
...
var _task_list = __webpack_require__(5);
...
var _task_list_view = __webpack_require__(6);

var _task_list_view2 = _interopRequireDefault(_task_list_view);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Import jQuery
var taskList; // /src/app.js
// Load Foundation Files


var render = function render(task) {
  // Select the template using jQuery
  var template_text = (0, _jquery2.default)('#taskItemTemplate').html();

  //console.log(template_text);
  // Get an underscore template object
  var template = _underscore2.default.template(template_text);
  ...
  (0, _jquery2.default)('.todo-items').append(compiledHTML);
  (0, _jquery2.default)('li.task-item:last').find('button.alert').click({ taskCid: task.cid }, function (params) {
    taskList.remove(params.data.taskCid);
  });
};

var renderList = function renderList(taskList) {
  // Clear the unordered list
  (0, _jquery2.default)('.todo-items').empty();
  // Iterate through the list rendering each Task
  taskList.each(function (task) {
    // Create a new TaskView with the model & template
    var taskView = new _task_view2.default({
      model: task,
      template: _underscore2.default.template((0, _jquery2.default)('#taskItemTemplate').html())
    });
    // Then render the TaskView
    // And append the resulting HTML to the DOM.
    (0, _jquery2.default)('.todo-items').append(taskView.render().$el);
  });
};
...
(0, _jquery2.default)(document).ready(function () {
  ...
  taskList = new _task_list2.default(taskData);
  taskList.on("update", function () {
    renderList(taskList);
  });

  var taskListView = new _task_list_view2.default({
    model: taskList,
    template: _underscore2.default.template((0, _jquery2.default)('#taskItemTemplate').html()),
    el: 'main'
  });
...
var readNewTaskForm = function readNewTaskForm() {
  // Get the values from the fields
  var title = (0, _jquery2.default)('#title').val();
  (0, _jquery2.default)('#title').val('');
  var description = (0, _jquery2.default)('#description').val();
  (0, _jquery2.default)('#description').val('');
  var completed = (0, _jquery2.default)('#completed-checkbox').is(":checked");
  (0, _jquery2.default)('#completed-checkbox').prop('checked', false);
